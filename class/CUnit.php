...
class CUnit
{
    ...
    private function _fillUnitData($id) {
		...
		if (MOD_REWRITE) {
			$this->_link['show'] = "/unit/{$this->id}";
			$this->_link['edit'] = "/?page=admin&act=admin_unit_form&id={$this->id}";
			$this->_link['arch'] = "/?page=admin&act=unit_arch&id={$this->id}";
			$this->_link['delete'] = "/?page=admin&act=unit_del&id={$this->id}";
		}
		else {
			$this->_link['show'] = "/?page=unit&id={$this->id}";
			$this->_link['edit'] = "/?page=admin&act=admin_unit_form&id={$this->id}";
			$this->_link['arch'] = "/?page=admin&act=unit_arch&id={$this->id}";
			$this->_link['delete'] = "/?page=admin&act=unit_del&id={$this->id}";
		}
		...
		$this->owner = new COwner($ur['owner_id']);
    ...
    function get() {
        ...
        $aUnit['unit']['links'] = $this->_link;

        $aUnit['unit']['owner'] = $this->owner->get()['owner'];
