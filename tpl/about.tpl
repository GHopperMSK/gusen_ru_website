...
<body>
    <div class="container" itemscope itemtype="http://schema.org/Organization">
        ...
        <div class="content">
	        <h1>О компании</h1>
			<p itemprop="description">Мы занимается продажей б/у спецтехники по всей России. В нашем каталоге всегда имеется широкий ассортимент предложений от складского погрузчика до роторного экскаватора! Техника реализуется непосредственно от собственника, что гарантирует ее оптимальную цену.</p>
			<p>Наши клиенты - кредитные организации, строительные компании и индивидуальные предприниматели. Компания проводит экспертизу всей техники, предоставляет всю необходимую информацию по каждой единице, организует осмотры и содействует в максимально быстром оформлении всех документов. Покупатель заключаете сделку с непосредственным собственником и не переплачиваете фирмам-посредникам. Все наши клиенты - проверенные компании с большой историей сотрудничества. Услуги агентства для покупателя абсолютно бесплатны.</p>
			...
			<p>Если вы планируете приобрести спецтехнику, звоните по номеру +7 (499) 322-76-88 и мы подберем для вас оптимальное предложение. На сайте предоставлена не вся техника, т.к. по некоторым единицам может быть не проведена экспертиза, согласована цена или отсутствовать иная информация. Звоните сейчас и уже завтра мы сможем вам предложить варианты для осмотра.</p>
			<p>Если вы хотите продать собственную б/у спецтехнику, звоните нам и приглашайте нашего специалиста для экспертизы. У нас есть большое количество интересантов во всех регионах РФ. Возможно, сейчас они в поисках именно вашего предложения!</p>
		</div>
