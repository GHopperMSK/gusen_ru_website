...
<div class="col-md-4 col-md-offset-4">
	<form class="form-horizontal" name="login" id="login" method="POST" action="?page=admin&act=check_login">
	    <fieldset>
	    <legend>Sign in</legend>
	        <div class="form-group">
	            <label class="control-label col-md-2" for="username">Username: </label>
	            <div class="col-md-10">
	            	<input class="form-control" type="text" size="100" name="username" id="username" value="" />
	            </div>
	        </div>
	        <div class="form-group">
	            <label class="control-label col-md-2" for="password">Password: </label>
	            <div class="col-md-10">
		            <input class="form-control" type="password" size="40" name="password" id="password" value="" />
		        </div>
	        </div>
	        <div class="form-group">
