...
<meta charset="utf-8" />
<title>%{title&null&page_search}%</title>
</head>
<body>
<script>
...
%{search_form&search_form.xsl&search}%
</section>
<section class="main_block content">
%{search_page_unit_list&search_page_unit_list.xsl}%
</section>
<section class="main_block paginator">
%{unit_list_paginator&search_paginator.xsl&search}% 
</section>
