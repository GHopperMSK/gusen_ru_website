...
<head>
    ...
    <meta name="description" content="%{DescriptionMod&null&10&unit_page}%">
    ...
    <title>%{TitleMod&null&10&unit_page}%</title>
    ...
    <div class="container">
        ...
        <div class="header">
            <a href="/" class="svglogo">
                <h1>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 366 72" role="img" aria-label="Агентство спецтехники «Гусеница»">
                    <title>Агентство спецтехники «Гусеница»</title>
                    <desc>Спецтехника б/у по всей России. Широкий ассортимент, гибкие условия. Продажа от собственника.</desc>
        ...
        <div class="content">
            %{UnitMod&unit_page_unit.xsl&10&unit_page}%
        </div>
